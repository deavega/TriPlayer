...
void Config::readConfig() {
    ...
    if (str == "English") {
        ...
        this->language_ = Language::Spanish;
    } else if (str == "ChineseTraditional") {
        this->language_ = Language::ChineseTraditional;
        ...
        this->language_ = Language::Korean;
    } else {
